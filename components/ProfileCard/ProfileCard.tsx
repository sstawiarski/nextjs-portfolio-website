    ...
    return (
        <aside className={mainClasses}>
            ...
            <div className="sm:mr-0 ml-10 md:ml-0">
                ...
                <InfoList>
                    <InfoItem Icon={SchoolIcon} header="Arizona State University" additional="3.8 GPA / Graduating May 2021" />
                    <InfoItem Icon={KnowledgeIcon} header="Java, JavaScript, React" additional="Node.js, TypeScript, Material-UI" />
                    <InfoItem
                        Icon={GitHubIcon}
                        header="@sstawiarski"
                        clickable
